...
class TrackingWheel {
    public:
         ...
         * cavalry::TrackingWheel verticalTrackingWheel(&verticalEncoder, cavalry::Omniwheel::NEW_275, -5);
         ...
         * cavalry::TrackingWheel horizontalTrackingWheel(&horizontalEncoder, cavalry::Omniwheel::OLD_325, -2, 5.0/3.0);
         * @endcode
         */
         ...
         * // the rpm is 360
         * cavalry::TrackingWheel leftTrackingWheel(&leftMotors, cavalry::Omniwheel::OLD_4, -5, 360);
         * @endcode
         */
         ...
         *
         * If you are using odometry provided by cavalry, this will automatically be called when
         ...
         *     cavalry::TrackingWheel exampleTrackingWheel(&exampleEncoder, cavalry::Omniwheel::NEW_275, 0.5);
         ...
         *     cavalry::TrackingWheel exampleTrackingWheel(&exampleRotationSensor, cavalry::Omniwheel::NEW_275, 0.5);
