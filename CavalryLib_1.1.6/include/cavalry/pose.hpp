...
class Pose {
    public:
         ...
         * @code {.cpp}
         * // create a pose
         * cavalry::Pose poseA(5, // x position
         *                    10, // y position
         *                    1.57); // heading
         * // create a pose
         * cavalry::Pose poseB(5.2, 22); // x and y position, heading defaults to 0
         * @endcode
         */
         ...
         * @code {.cpp}
         * // create a pose
         * cavalry::Pose poseA(5, 10, 1.57);
         * // create a pose
         * cavalry::Pose poseB(5.2, 22, 2.22);
         * // add the two poses
         * cavalry::Pose poseC = poseA + poseB;
         ...
         * @code {.cpp}
         * // create a pose
         * cavalry::Pose pose(1, 2);
         * // multiply the pose by 4.0
         * cavalry::Pose result = pose * 4.0;
         ...
         * @code {.cpp}
         * // create a pose
         * cavalry::Pose pose(6, 8);
         * // divide the pose by 2
         * cavalry::Pose result = pose / 2;
         ...
         * @code {.cpp}
         * // create poses
         * cavalry::Pose poseA(0, 0);
         * cavalry::Pose poseB(0, 2);
         * // find the pose in between the 2 poses
         * cavalry::Pose result = poseA.lerp(poseB, 0.5);
         ...
         * @code {.cpp}
         * // create poses
         * cavalry::Pose poseA(-1, -2);
         * cavalry::Pose poseB(2, 1);
         ...
         * @code {.cpp}
         * // create pose
         * cavalry::Pose pose(1, 0);
         * // rotate pose by pi/2
         * cavalry::Pose result = pose.rotate(M_PI_2);
         * // result.x = 0, result.y = 1
         * @endcode
         */
