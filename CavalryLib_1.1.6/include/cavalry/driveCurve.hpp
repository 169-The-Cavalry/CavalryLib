 ...
 * see https://www.vexforum.com/t/expo-drive-cavalrys-implementation for a detailed explanation
 */
class ExpoDriveCurve : public DriveCurve {
    public:
         ...
         * cavalry::ExpoDriveCurve driveCurve(5, 12, 1.132);
         * @endcode
         */
