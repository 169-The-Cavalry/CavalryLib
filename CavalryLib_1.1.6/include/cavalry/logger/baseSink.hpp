...
namespace cavalry {
/**
 * @brief A base for any sink in cavalry to implement.
 *
 * Sinks are cavalry's abstraction for destinations that logged messages can be sent to. They are the backbone of the
...
class BaseSink {
    public:
         ...
         * <h3> Example Usage </h3>
         * @code
         * cavalry::BaseSink combinedSink({cavalry::telemetrySink(), cavalry::infoSink()});
         ...
         * <h3> Example Usage </h3>
         * @code
         * sink.log(cavalry::Level::INFO, "{} from the logger!", "Hello");
         * @endcode
    ...
    protected:
         ...
         * <h3> Example Usage </h3>
         * @code
         * infoSink()->setFormat("[cavalry] -- {time} -- {level}: {Message}");
         * infoSink()->info("hello");
         * // This will be formatted as:
         * // "[cavalry] -- 10 -- INFO:  hello"
         * @endcode
         */
