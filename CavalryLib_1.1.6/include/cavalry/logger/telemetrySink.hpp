 ...
 *
 * This is the primary way of interacting with the telemetry portion of cavalry's logging implementation. This sink is
 ...
 * <h3> Example Usage </h3>
 * @code
 * cavalry::telemetrySink()->setLowestLevel(cavalry::Level::INFO);
 * cavalry::telemetrySink()->info("{},{}", motor1.get_temperature(), motor2.get_temperature());
 * @endcode
 */
